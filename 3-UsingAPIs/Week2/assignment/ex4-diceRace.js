...
// The continued execution of some dice after the promise returned by `Promise.race()`
// resolves is because `Promise.race()` does not cancel ongoing tasks.
// As a result, the remaining promises created by `rollDie()` keep executing.
