...
function main() {
  ...
  const numKids = [ 0, 2, 3, 4, 5, 10];

  const partnerNames = ['Yos', 'Jessie', 'Willow', 'Arlo', 'Noah', 'Nicki'];

  const locations = ['Amsterdam', 'Lisbon', 'Barcelona', 'Oslo', 'Porto', 'Hawaii'];

  const jobTitles = ['Developer', 'Designer', 'Writer', 'Dancer', 'Singer', 'Chef'];
