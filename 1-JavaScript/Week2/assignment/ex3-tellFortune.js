...
function main() {
  ...
  const numKids = [ 0, 2, 4, 5, 10];

  const partnerNames = ['Yos', 'Jessie', 'Willow', 'Arlo', 'Nick'];

  const locations = ['Amsterdam', 'Lisbon', 'Barcelona', 'Porto', 'Hawaii'];

  const jobTitles = ['Developer', 'Designer', 'Dancer', 'Singer', 'Chef'];
